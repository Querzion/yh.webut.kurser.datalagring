...
public static class CustomerFactory
{
    ...
    // Record is added like this!
    public static Customer Create(CustomerEntity entity) => new(entity.Id, entity.FirstName, entity.LastName, entity.Email, entity.PhoneNumber);
}